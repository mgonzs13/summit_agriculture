...
, subscription_{ create_subscription<sensor_msgs::msg::PointCloud2>("~/input", rclcpp::QoS(1).reliable(), std::bind(&FilterNode::topic_callback, this, std::placeholders::_1)) }
{
}

void FilterNode::topic_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
{
